...
abstract class $CurrencyCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? currency, String? locale, String? symbol, bool? selected});
}
...
class _$_Currency extends _Currency {
  _$_Currency({this.currency, this.locale, this.symbol, this.selected = false})
      : super._();
  ...
  @override
  String toString() {
    return 'Currency(currency: $currency, locale: $locale, symbol: $symbol, selected: $selected)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, currency, locale, symbol, selected);
...
abstract class _Currency extends Currency {
  factory _Currency(
      ...
      final String? locale,
      final String? symbol,
      final bool? selected}) = _$_Currency;
  _Currency._() : super._();
